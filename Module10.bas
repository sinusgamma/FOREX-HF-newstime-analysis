...
Sub AAA_reportMakeUp()
Attribute AAA_reportMakeUp.VB_ProcData.VB_Invoke_Func = " \n14"
'
' AAA_reportMakeUp Macro
'
...
'    Selection.EntireColumn.Hidden = True
    Columns("I:I").Select
    Selection.FormatConditions.Add Type:=xlTextString, String:="SHORT", _
    ...
    Selection.FormatConditions.Add Type:=xlTextString, String:="LONG", _
        TextOperator:=xlContains
    Selection.FormatConditions(Selection.FormatConditions.Count).SetFirstPriority
    With Selection.FormatConditions(1).Font
        .Color = -16752384
...
'    Selection.EntireColumn.Hidden = True
    ...
    End With
    Range("R1").Select
    ActiveCell.FormulaR1C1 = "breakevenTrigger"
    Columns("R:R").Select
    Selection.FormatConditions.AddColorScale ColorScaleType:=3
    Selection.FormatConditions(Selection.FormatConditions.Count).SetFirstPriority
    Selection.FormatConditions(1).ColorScaleCriteria(1).Type = _
